...
const AllDaos = () => (
    <div className="flex flex-wrap w-full py-4 cursor-pointer justify-between px-12">
        {AllDaosData.map((dao) => (
            <a href={`${DAOS}/${dao.id}`} className="p-8 rounded-xl w-5/12 bg-white my-4" style={{ boxShadow: 'rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px' }} key={dao.id}>
                <div>
